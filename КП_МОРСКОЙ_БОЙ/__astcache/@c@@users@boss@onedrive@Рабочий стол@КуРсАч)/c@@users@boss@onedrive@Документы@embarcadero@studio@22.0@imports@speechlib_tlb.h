...
// *********************************************************************//
interface ISpStreamFormat  : public IStream
{
public:
...
{
public:
  virtual HRESULT STDMETHODCALLTYPE SetBaseStream(IStream* pStream/*[in]*/, 
                                                  System::TGUID* rguidFormat/*[in]*/, 
                                                  Speechlib_tlb::WAVEFORMATEX* pWaveFormatEx/*[in]*/) = 0; // [1610874880]
  virtual HRESULT STDMETHODCALLTYPE GetBaseStream(IStream** ppStream/*[out]*/) = 0; // [1610874881]
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE SpeakStream(IStream* pStream/*[in]*/, 
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE SaveCmd(IStream* pStream/*[in]*/, 
...
public:
  ...
  HRESULT         __fastcall SetBaseStream(IStream* pStream/*[in]*/, 
                                           System::TGUID* rguidFormat/*[in]*/, 
                                           Speechlib_tlb::WAVEFORMATEX* pWaveFormatEx/*[in]*/);
  HRESULT         __fastcall GetBaseStream(IStream** ppStream/*[out]*/);
...
// *********************************************************************//
template <class T> HRESULT __fastcall
TCOMISpStreamT<T>::SetBaseStream(IStream* pStream/*[in]*/, System::TGUID* rguidFormat/*[in]*/, 
                                 Speechlib_tlb::WAVEFORMATEX* pWaveFormatEx/*[in]*/)
{
...
template <class T> HRESULT __fastcall
TCOMISpStreamT<T>::GetBaseStream(IStream** ppStream/*[out]*/)
{
  return (*this)->GetBaseStream(ppStream);
}
